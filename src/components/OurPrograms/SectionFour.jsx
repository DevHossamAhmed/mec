  ...
  return (
    <div className='pt-[35px]'>
        ...
        >
            ...
            <div className='bg-[#191a25] w-[250px] '>
                <Image src={Img2} alt='Img1' />
                <h1 className='text-[#a0a3a7] pr-[15px] pl-[15px] text-[16px] font-bold pt-[10px]'>    المبادئ والاساسيات التحليل الفني</h1>
                <p className='text-white pr-[15px] pl-[15px] text-[16px] '>برامج السوق المالية</p>
                <div className='flex w-full text-white  justify-between pr-[15px] pl-[15px] text-[15px] font-semibold pt-[10px]'>
                    <h2>ر.س <span className='font-bold'>1500</span></h2>
                    <h2 className='flex items-center gap-[8px]'>15 ابريل
                        <BiCalendar/>
                    </h2>
