...
const Program = () => {
  return (
    <div>
        ...
        <div className='flex container m-auto text-white gap-6 mt-[30px] flex-col xl:flex-row'>
            <div className='w-[25%] h-[150px] border-b-[4px] border-b-[#e4b00a] rounded-md bg-[#191a25] p-[20px] leading-[30px]'>
            ...
            <div className='w-[25%] h-[150px] rounded-md border-b-[4px] border-b-[#14c61b] bg-[#191a25] p-[20px] leading-[30px]'>
            ...
            <div className='w-[25%] h-[150px] rounded-md border-b-[4px] border-b-[#0c3070] bg-[#191a25] p-[20px] leading-[30px]'>
            ...
            <div className='w-[25%] h-[150px] rounded-md border-b-[4px] border-b-[#8b2b0f] bg-[#191a25] p-[20px] leading-[30px]'>
